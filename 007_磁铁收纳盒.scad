...
// radius = 10.8/2;    // 7 号电池 
radius_6 = 6.2/2;    // 5 号电池
radius_5 = 5.4/2;    // 5 号电池
radius_4 = 4.4/2;    // 5 号电池
radius_3 = 3.3/2;    // 5 号电池

bin_render(bin_11) {
    depth = bin_get_infill_size_mm(bin_11).z;
    bin_subdivide(bin_11, [5, 6]) {
        translate([0, 0, -depth])
        ...
        child_per_element() {
            ...
            circle_polygon(radius=radius_6, $fn=100);
            linear_extrude(depth)
            circle_polygon(radius=radius_6, $fn=100);
            linear_extrude(depth)
            circle_polygon(radius=radius_6, $fn=100);
            ...
            // 5mm 
            linear_extrude(depth)
            circle_polygon(radius=radius_5, $fn=100);
            linear_extrude(depth)
            circle_polygon(radius=radius_5, $fn=100);
            linear_extrude(depth)
            circle_polygon(radius=radius_5, $fn=100);
            ...
            // 4mm 
            linear_extrude(depth)
            circle_polygon(radius=radius_4, $fn=100);
            linear_extrude(depth)
            circle_polygon(radius=radius_4, $fn=100);
            linear_extrude(depth)
            circle_polygon(radius=radius_4, $fn=100);
            ...
            // 3mm 
            linear_extrude(depth)
            circle_polygon(radius=radius_3, $fn=100);
            linear_extrude(depth)
            circle_polygon(radius=radius_3, $fn=100);
            linear_extrude(depth)
            circle_polygon(radius=radius_3, $fn=100);
